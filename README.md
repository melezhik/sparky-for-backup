...
- агенты также настраивают метрик бэкапипования в развернутый внешний прометеус для последующего мониторинга
